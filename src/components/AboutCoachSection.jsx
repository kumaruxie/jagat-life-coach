      ...
      <div className="section-inner">
        <div className="grid-2-col" style={{ alignItems: 'center' }}>
          ...
          >
            ...
            <h2 style={{ marginBottom: '2rem' }}>Meet Jagat Turkiya</h2>
            
            <p style={{ marginBottom: '1.5rem', fontSize: '1.125rem' }}>
              Main ek Life Strategic Family Coach aur Mind Hacker hoon — lekin meri journey kisi textbook se nahi, real-life struggles se shuru hui thi. Maine personally dekha hai ki ek unresolved family conflict kaise ek capable aur intelligent insaan ko andar se khaali kar deta hai.
            </p>
            
            <p style={{ marginBottom: '2.5rem', fontSize: '1.125rem' }}>
              Aaj tak maine 1,500+ logon ke saath 1-on-1 kaam kiya hai, aur 12,000+ participants ko live events aur webinars mein transform kiya hai. Main ek Guinness World Records Speaker, Nation Icon Award Winner, aur 4 best-selling books ka author hoon — lekin jo cheez mujhe sabse zyada proud karti hai, woh hai mere clients ke ghar mein aane wala real badlaav.
            </p>
